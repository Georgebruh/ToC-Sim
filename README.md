...
TOC Sim is a web application designed to help Computer Science students visualize, build, and understand Finite Automata (DFA/NFA). By combining interactive graph drawing with an integrated AI tutor, it transforms abstract theoretical concepts into tangible, explorable experiments.
